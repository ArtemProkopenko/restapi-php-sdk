...
class Immocaster_Immobilienscout
{
     ...
     * @return mixed
     */
    protected function restRequest($sPath = '', $aArgs = [], $bSecurity = false, $oToken = null, $requestMethod = 'GET')
    {
     ...
     * @return mixed
     */
    protected function getContent($req, $sSecret = null, $aHeader = [])
    {
        if ($this->_sAuthType == 'oauth') {
            ...
            if ($this->_sUrlReadingType == 'none') {
                $opts = ['http' => ['ignore_errors' => true, 'header' => implode("\r\n", $sNewHeader)]];
